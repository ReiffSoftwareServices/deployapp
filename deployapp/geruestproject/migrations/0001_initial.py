# Generated by Django 2.0.2 on 2018-05-28 15:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Eingangsdatum', models.DateField(default=datetime.date(2018, 5, 28), verbose_name='Eingangsdatum')),
                ...
                ('Ansprechpartner', models.ForeignKey(on_delete='PROTECT', to='geruestproject.Ansprechpartner', verbose_name='Ansprechpartner')),
                ('Kunde', models.ForeignKey(on_delete='PROTECT', to='geruestproject.Firma', verbose_name='Firma')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='Firma',
            field=models.ForeignKey(on_delete='PROTECT', to='geruestproject.Firma', verbose_name='Firma'),
        ),
    ]
