	  ...
	  <div class="card-body">
		...
		<p class="card-text">
			<form>
			  ...
			  <div class="form-group">
				<select class="form-control" id="exampleFormControlSelect1" placeholder="Firma Name"><option>Firma</option><option>Firma 1</option><option>Firma 2</option><option>Firma 3</option><option>Firma 4</option></select>
			  ...
			  <div class="form-group">
				<div class="input-group">
						<input type="text" class="form-control" placeholder="Nutzungsbeginn">
						<input type="text" class="form-control" placeholder="Nutzungsdauer">
				</div>
